<?php 
if(!function_exists('darknews_by_author')){
    function darknews_by_author($gravatar=''){
            ...
            if(isset($awpa_post_authors) && !empty($awpa_post_authors) && $multiauthor_settings == true){
                foreach ($awpa_post_authors as $key=>$author_id) {
                    ...
                    if (strpos($author_id, $needle) !== false) {
                     ...
                     darknews_author_list($post_id,$author_id,$author_type, $gravatar);
...
if(!function_exists('darknews_author_list')){
function darknews_author_list($post_id='',$author_id='',$author_type='',$gravatar=false){
