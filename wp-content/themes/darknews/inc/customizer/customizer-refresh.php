...
$wp_customize->selective_refresh->add_partial('select_main_banner_carousel_filterby', array(
    'selector' => 'div.aft-main-banner-part',     
));

$wp_customize->selective_refresh->add_partial('select_banner_latest_post_filterby', array(
    'selector' => 'div.aft-trending-part',     
));

$wp_customize->selective_refresh->add_partial('select_editors_picks_filterby', array(
    'selector' => 'div.aft-thumb-part',     
));
